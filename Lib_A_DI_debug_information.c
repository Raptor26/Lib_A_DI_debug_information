 ...
 *              uint16_t bytesCnt = DI_CopyDataForSerialPlot_f32(
 *                  &dataForSerialPlotStruct,
 *                  (float) data1,
 *                  (float) data2,
 *                  (float) data3,
 *                  (float) data4,
...
DI_CopyDataForSerialPlot_f32(
	...
	...)
{
	pStruct->frameStart = (uint16_t) DI_START_FRAME_SYMBOL;
